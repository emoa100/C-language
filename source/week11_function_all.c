/*
   파일명: week11_function.c 
   설  명: 매개변수&인수, 반환값&(반환) 결과 대입 변수  
   이  름: mju 
*/
...
void doExam1()
{
	...
	int value;
	//2. 함수 호출 max
	value = max(10, 20);  // 인수(실제값),  리턴했을때 결과 대입 변수  
	//3. 함수 결과 출력
	printf("(10,20)의 max 값: %d \n", value);
	
	//함수호출 min 
	value = min(10, 20); // 인수(실제값),  리턴했을때 결과 대입 변수 
...
void doExam2()
{
	...
	double area; 
	//2. 함수 호출 
	area = get_area(10); // 인수(실제값), 리턴했을때 결과 대입 변수- 실수 
	//3. 함수 결과 출력
	printf("10의 원의 넓이는 : %.2f \n", area); 
	area = get_rect(10, 20); // 인수(실제값) 2개,  리턴했을때 결과 대입 변수- 실수
...
{	
	...
	int x;
	//2. 함수 호출
	x = get_integer(); // 리턴했을때 결과 대입 변수- 정수 
	//3. 함수 결과 출력 
	printf("입력받은 정수 값은 : %d \n", x); 
	
	//1.변수 선언 - 문자 x
	char value;
	value = get_char(); // 리턴했을때 결과 대입 변수- 문자  
	printf("입력받은 문자는 : %c \n", value); 
...
void doExam5()
{
	...
	y = get_integer();
    //3. add 함수 출력
	value = add(x, y); // 인수(실제값- 2개), 정수 변수에 대입
